...
class nestedsets
{
    ...
    protected $FieldIDParent = 'parent_id';
    protected $FieldOrder    = 'ordering';
    protected $FieldLeft     = 'ns_left';
    protected $FieldRight    = 'ns_right';
    protected $FieldDiffer   = 'ns_differ';
    protected $FieldLevel    = 'ns_level';
    protected $FieldIgnore   = 'ns_ignore';
    protected $db;
    ...
    public function setOption($parent_id, $ordering, $ns_left, $ns_right, $ns_differ, $ns_level, $ns_ignore)
    {
    ...
    {
        $var_true = isset($var_true) ? $var_true : $var_false;
    }
