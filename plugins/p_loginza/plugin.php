...
class p_loginza extends cmsPlugin
{
    ...
    public function execute($event = '', $item = array())
    {
        ...
        switch ( $event ) {
            case 'LOGINZA_BUTTON': $item = $this->showLoginzaButton();
                break;
            case 'LOGINZA_AUTH': $item = $this->loginzaAuth();
                break;
        }
    ...
    private function createUser($profile)
    {
        ...
        $user_array = \cms\plugins::callEvent('users.before_register', array(
        ...
        if ( $user_id ) {
            ...
            \cms\plugins::callEvent('users.register', $user_array);
