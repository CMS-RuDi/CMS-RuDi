...
$_LANG['INS_DELETE_TODO']      = 'До перехода на сайт необходимо удалить каталог "install" на сервере вместе со всеми находящимися в них файлами!';
...
$_LANG['INS_DELETE_INST_MIGRATE'] = 'Если процесс установки был закончен,<br/> удалите папку "install" на сервере и обновите страницу.';
