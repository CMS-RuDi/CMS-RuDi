...
CREATE TABLE IF NOT EXISTS `cms_plugins` (
  ...
  `url` varchar(255) NULL DEFAULT NULL COMMENT 'Ссылка на страницу плагина',
  `author` varchar(255) NOT NULL COMMENT 'Автор',
  `author_url` varchar(255) NULL DEFAULT NULL COMMENT 'Сайт автора',
  `author_email` varchar(255) NULL DEFAULT NULL COMMENT 'Email автора',
