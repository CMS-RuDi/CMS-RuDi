...
<form name="configform" id="club_config_form" action="" method="post" enctype="multipart/form-data">
    ...
    <div id="configtabs" style="margin-top:20px" class="uitabs">
        <ul id="tabs">
            <li><a href="#about">
                    <span>{$LANG.CLUB_DESC}</span></a>
            </li>
            <li><a href="#moders">
                    <span>{$LANG.MODERATORS}</span></a>
            </li>
            <li>
                <a href="#members"><span>{$LANG.MEMBERS}</span></a>
            </li>
            {if $club.enabled_photos || $club.enabled_blogs}
                <li>
                    <a href="#limits"><span>{$LANG.LIMITS}</span></a>
                </li>
            {/if}
            {if $is_admin}
                <li>
                    <a href="#vip"><span>VIP</span></a>
                </li>
            {/if}
            {if $cfg.seo_user_access || $is_admin}
                <li>
                    <a href="#seo"><span>SEO</span></a>
                </li>
            {/if}
        </ul>
