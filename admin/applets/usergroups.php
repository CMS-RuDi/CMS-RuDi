                ...
                <tr>
                    ...
                    <td>
                        <label><input name="is_admin" type="radio" value="1" <?php
                            ...
                            ?> onclick="$('#accesstable').hide();$('#admin_accesstable').show();"/> <?php echo $_LANG['YES']; ?> </label>
                        <label><input name="is_admin" type="radio" value="0"  <?php
                            if ( @!$mod['is_admin'] ) {
                                echo 'checked="checked"';
                            }
                            ?> onclick="$('#accesstable').show();$('#admin_accesstable').hide();"/> <?php echo $_LANG['NO']; ?></label>
                    </td>
                </tr>
            </table>
                    ...
                    <td valign="top">
                        <table width="100%" border="0" cellspacing="2" cellpadding="0">
                            ...
                            foreach ( $coms as $com ) {
                                ...
                                ?>
                                <tr>
                                    <td width="16"><input type="checkbox" name="access[]" id="admin_com_<?php echo $com['link']; ?>" value="admin/com_<?php echo $com['link']; ?>" <?php
                                        if ( isset($mod['access']) ) {
                    ...
                    <td width="475" valign="top">
                        <table width="100%" border="0" cellspacing="2" cellpadding="0">
                            ...
                            while ( $ga = $inDB->fetch_assoc($res) ) {
                                ...
                                ?>
                                <tr>
                                    <td width="16"><input type="checkbox" name="access[]" id="<?php echo str_replace('/', '_', $ga['access_type']); ?>" value="<?php echo $ga['access_type']; ?>" <?php
                                        if ( isset($mod['access']) ) {
