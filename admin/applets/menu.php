...
function iconList()
{
    ...
    if ( !$n ) {
        echo '<p>' . $_LANG['AD_EMPTY_FOLDER'] . '</p>';
    }
...
function cpMenutypeById($item)
{
    ...
    if ( mb_strlen($clear) > $maxlen ) {
        $html = mb_substr($html, 0, $maxlen + $r) . '...';
    }
    return $html;
}
                    ...
                    <td valign="top">
                        ...
                        <div>
                            ...
                            <select name="parent_id" size="10" id="parent_id" style="width:100%">
                                ...
                                ?>><?php echo $_LANG['AD_MENU_ROOT']; ?></option>
                                        <?php
