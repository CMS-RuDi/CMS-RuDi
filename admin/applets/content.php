                        ...
                        <table width="100%" cellpadding="0" cellspacing="4" border="0">
                            <tr>
                                ...
                                <td width="16" valign="bottom" style="padding-bottom:10px">
                                    <input type="checkbox" name="showdate" id="showdate" title="<?php echo $_LANG['AD_VIEW_DATE_AND_AUTHOR']; ?>" value="1" <?php
                    ...
                    <td width="300" valign="top" style="background:#ECECEC;">
                        ...
                        <div style="margin-top:7px">
                            <select name="category_id" size="10" id="category_id" style="width:99%;height:200px">
                                ...
                                ?>><?php echo $_LANG['AD_ROOT_CATEGORY']; ?></option>
                                        <?php
                        ...
                        <div style="margin-bottom:10px">
                            <select name="showpath" id="showpath" style="width:99%">
                                ...
                                ?>><?php echo $_LANG['AD_PATHWAY_NAME_ONLY']; ?></option>
                                <option value="1" <?php
                                if ( @$mod['showpath'] ) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $_LANG['AD_PATHWAY_FULL']; ?></option>
                            </select>
                        </div>
                        ...
                        <div>
                            <select name="is_end" id="is_end" style="width:99%" onchange="if ($(this).val() == 1) {
                                ...
                                ?>><?php echo $_LANG['AD_UNLIMITED']; ?></option>
                                <option value="1" <?php
                                if ( @$mod['is_end'] ) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $_LANG['AD_TO_FINAL_TIME']; ?></option>
                            </select>
                        </div>
