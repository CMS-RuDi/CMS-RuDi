                    ...
                    <td valign="top">
                        ...
                        <div>
                            ...
                            <select name="parent_id" size="12" id="parent_id" style="width:100%" onchange="if ($('option:selected', this).data('nsleft') >= '<?php echo $mod['NSLeft']; ?>' && $('option:selected', this).data('nsright') <= '<?php echo $mod['NSRight']; ?>') {
                                ...
                                ?>><?php echo $_LANG['AD_SECTION']; ?></option>
                                        <?php
                    ...
                    <td valign="top" width="350" style="background:#ECECEC;">
                        ...
                        <div>
                            <select name="orderby" id="orderby" style="width:100%">
                                ...
                                ?>><?php echo $_LANG['AD_BY_TITLE']; ?></option>
                                <option value="ordering" <?php
                                if ( @$mod['orderby'] == 'ordering' ) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $_LANG['AD_BY_ORDER']; ?></option>
                        ...
                        <div>
                            <select name="modgrp_id" id="modgrp_id" style="width:100%">
                                ...
                                ?>><?php echo $_LANG['AD_ONLY_ADMINS']; ?></option>
                                        <?php
                                        if ( @$mod['modgrp_id'] ) {
                        ...
                        <div>
                            <select name="album_id" id="album_id" style="width:100%" onchange="choosePhotoAlbum()">
                                ...
                                ?>><?php echo $_LANG['AD_DONT_CONNECT']; ?></option>
                                        <?php
                                        //FIND ROOT
