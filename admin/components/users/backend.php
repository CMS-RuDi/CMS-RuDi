        ...
        <div id="basic">
            <table width="550" border="0" cellpadding="10" cellspacing="0" class="proptable" style="border:none">
                ...
                <tr>
                    ...
                    <td>
                        <label><input name="sw_search" type="radio" value="1" <?php
                ...
                <tr>
                    ...
                    <td width="">
                        <label><input name="sw_comm" type="radio" value="1" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label><input name="sw_wall" type="radio" value="1" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label><input name="sw_blogs" type="radio" value="1" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label><input name="sw_msg" type="radio" value="1" <?php
        ...
        <div id="proftabs">
            <table width="450" border="0" cellpadding="10" cellspacing="0" class="proptable" style="border:none">
                <tr>
                    ...
                    <td width="210">
                        <label><input name="sw_feed" type="radio" value="1" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label><input name="sw_clubs" type="radio" value="1" <?php
                ...
                <tr>
                    ...
                    <td>
                        <label><input name="sw_awards" type="radio" value="1" <?php
        ...
        <div id="files">
            <table width="550" border="0" cellpadding="10" cellspacing="0" class="proptable" style="border:none">
                <tr>
                    ...
                    <td width="210">
                        <label><input name="sw_files" type="radio" value="1" <?php
