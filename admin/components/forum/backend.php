...
if ( $opt == 'saveconfig' ) {
    ...
    while ( mb_strpos($cfg['fa_ext'], 'htm') || mb_strpos($cfg['fa_ext'], 'php') || mb_strpos($cfg['fa_ext'], 'ht') ) {
...
if ( $opt == 'show_forum' ) {
    if ( !isset($_REQUEST['item']) ) {
        if ( isset($_REQUEST['item_id']) ) {
            dbShow('cms_forums', cmsCore::request('item_id', 'int', 0));
        }
        echo '1';
        exit;
    }
...
if ( $opt == 'hide_forum' ) {
    if ( !isset($_REQUEST['item']) ) {
        if ( isset($_REQUEST['item_id']) ) {
            dbHide('cms_forums', cmsCore::request('item_id', 'int', 0));
        }
        echo '1';
        exit;
    }
