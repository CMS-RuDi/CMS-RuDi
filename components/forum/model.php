...
class cms_model_forum
{
    ...
    {
        if ( cmsUser::isUserCan('forum/moderate') ) {
            return true;
        }

        if ( !$moder_list || !cmsUser::getInstance()->id ) {
            return false;
        }

        $moder_list = cmsCore::yamlToArray($moder_list);

        if ( !is_array($moder_list) ) {
            return false;
        }
...
//============== методы для кеширования статистических даных =================//
    ...
    public function getThread($id)
    {
        $thread = $this->inDB->get_fields('cms_forum_threads t
                                           INNER JOIN cms_forums f ON f.id = t.forum_id', "t.id = '" . $id . "'", 't.*, f.NSLeft, f.NSRight');
        ...
        return \cms\events::call('forum.get_thread', $thread);
    }
    ...
    public function getForumCat($id)
    {
        ...
        return \cms\events::call('forum.get_category', $cat);
    }
    ...
    public function getForum($id)
    {
        ...
        return \cms\events::call('forum.get_forum', $forum);
    }
    ...
    public function getPost($id)
    {
        ...
        return \cms\events::call('forum.get_post', $post);
    }
    ...
    public function getForums($is_admin = false)
    {
        ...
        return \cms\events::call('forum.get_forums', $nested_forums);
    }
    ...
    public function getThreads()
    {
        ...
        return \cms\events::call('forum.get_threads', $threads);
    }
    ...
    public function getPosts()
    {
        ...
        return \cms\events::call('forum.get_posts', $posts);
    }
    ...
    {
        if ( $this->config['edit_minutes'] == 0 ) {
            return true;
        }
        if ( $this->config['edit_minutes'] == -1 ) {
            return false;
        }
    ...
    public function addPost($post)
    {
        ...
        $post_id = $this->inDB->insert('cms_forum_posts', \cms\events::call('forum.add_post', $post));
    ...
    {
        \cms\events::call('forum.update_post', $post_id);
    ...
    {
        \cms\events::call('forum.delete_post', $post_id);
    ...
    {
        return $this->inDB->insert('cms_forum_threads', \cms\events::call('forum.add_thread', $thread));
    }

    public function closeThread($thread_id)
    {
        \cms\events::call('forum.close_thread', $thread_id);
    ...
    {
        \cms\events::call('forum.open_thread', $thread_id);
    ...
    {
        \cms\events::call('forum.update_thread', $thread_id);
...
//=================== методы для прикрепленных файлов ========================//
    ...
    {
        \cms\events::call('forum.delete_post_file', $file);
    ...
    public function getPostAttachment($file_id)
    {
        ...
        return \cms\events::call('forum.get_post_file', $file);
    }
    ...
    public function getPostAttachments($post_id)
    {
        ...
        return \cms\events::call('forum.get_post_files', $files);
    }
...
//========================== методы для опросов ==============================//
    ...
    public function addPoll($poll, $thread_id)
    {
        ...
        return $this->inDB->insert('cms_forum_polls', \cms\events::call('forum.add_poll', $t_poll));
    }
    ...
    public function updatePoll($poll, $latest_poll)
    {
        ...
        return $this->inDB->update('cms_forum_polls', \cms\events::call('forum.update_poll', $t_poll), $latest_poll['id']);
    }
    ...
    public function getPoll($where)
    {
        ...
        return \cms\events::call('forum.get_thread_poll', $poll);
    }

    public function deletePoll($poll_id)
    {
        \cms\events::call('forum.delete_poll', $poll_id);
