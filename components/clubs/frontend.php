...
//================================ ПРОСМОТР КЛУБА ============================//
    ...
    if ( $do == 'club' ) {
        ...
        if ( !$club['published'] && !$inUser->is_admin ) {
            return false;
        }
...
//=============================== НАСТРОЙКИ КЛУБА ============================//
    ...
    if ( $do == 'config' ) {
        ...
        if ( !cmsCore::inRequest('save') ) {
            ...
            if ( $fr_plus_members ) {
                $fr_members_list = cmsUser::getAuthorsList($fr_plus_members);
            }
            else {
                $fr_members_list = '';
            }
            ...
            if ( $moderators ) {
                $moders_list = cmsUser::getAuthorsList($moderators);
            }
            else {
                $moders_list = '';
            }
            ...
            if ( $members ) {
                $members_list = cmsUser::getAuthorsList($members);
            }
            else {
                $members_list = '';
            }
...
//============================= ВЫХОД ИЗ КЛУБА ===============================//
    ...
    if ( $do == 'leave' ) {
        ...
        if ( cmsCore::inRequest('confirm') ) {
            ...
            \cms\plugins::callEvent('clubs.leave', $club);
...
//========================== ВСТУПЛЕНИЕ В КЛУБ ===============================//
    ...
    if ( $do == 'join' ) {
        ...
        //
        if ( cmsCore::inRequest('confirm') ) {
            \cms\plugins::callEvent('clubs.join', $club);
    ...
    if ( $do == 'join_member' ) {
        ...
        if ( !cmsCore::inRequest('join') ) {
            ...
            if ( $users ) {
                ...
                $message = str_replace(array( '%user%', '%club%', '%link_join%' ), array( $user_link, $club_link, $link_join ), $_LANG['INVITE_CLUB_TEXT']);
...
//=========================== ПРОСМОТР ФОТО ==================================//
    ...
    if ( $do == 'view_photo' ) {
        ...
        $photo = \cms\plugins::callEvent('clubs.view_photo', $photo);
        ...
        if ( !$photo['published'] && !$is_admin && !$is_moder ) {
            return false;
        }
...
//============================ РЕДАКТИРОВАТЬ ФОТО ============================//
    ...
    if ( $do == 'edit_photo' ) {
        ...
        if ( !$is_admin && !$is_moder && !$is_author ) {
            cmsCore::halt();
        }
