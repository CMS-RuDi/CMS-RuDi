...
//============================== VIEW PHOTO ==================================//
    ...
    if ( $do == 'viewphoto' ) {
        // получаем фото
        $photo = \cms\plugin::callEvent('photos.get_photo', $inPhoto->getPhoto($id));
...
//================================= PHOTO MOVE ===============================//
    ...
    if ( $do == 'movephoto' ) {
        ...
        if ( !cmsCore::inRequest('move_photo') ) {
            ...
            $album = \cms\plugin::callEvent('photos.get_album', $inDB->getNsCategory('cms_photo_albums', cmsCore::request('album_id', 'int')));
