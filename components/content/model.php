...
class cms_model_content
{
    ...
    public function getSubCats($parent_id, $recurse = false, $left_key = 0, $right_key = 0)
    {
        ...
        return \cms\events::call('content.get_sub_categories', $subcats);
    }
    ...
    public function getCatsTree()
    {
        ...
        $subcats = \cms\events::call('content.get_categories_tree', $subcats);
    ...
    public function getArticlesList($only_published = true)
    {
        ...
        $articles = \cms\events::call('content.get_items', $articles);
    ...
    {
        \cms\events::call('content.delete_item', $id);
