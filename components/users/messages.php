...
$interlocutors = cmsCore::getListItems("cms_users u INNER JOIN cms_user_msg m ON m.from_id = u.id", ". $whith_id .", 'm.from_id', 'ASC', "m.from_del = 0 AND m.to_del = 0 AND m.to_id = '" . $id . "' GROUP BY m.from_id", 'from_id', 'nickname');
